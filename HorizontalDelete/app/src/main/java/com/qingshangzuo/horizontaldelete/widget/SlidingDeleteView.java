package com.qingshangzuo.horizontaldelete.widget;
...
import com.qingshangzuo.horizontaldelete.R;
...
public class SlidingDeleteView extends HorizontalScrollView {
    ...
    private LinearLayout slidingParent; // 抽屉视图(注意：recyclerview/listview中不能使用button，button会抢夺焦点) - 父件
    public boolean isEnable = true;  //是否开启滑动抽屉
    /**
     * 抽屉视图是否可见
     */
    ...
    private void init() {
        slidingParent =  findViewById(R.id.lay_sliding);
    }
